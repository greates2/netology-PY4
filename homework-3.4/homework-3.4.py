...
def main():
    ...
    c = set(access_to_my_friends()) & set(x for x in all_my_friends2)
    # print("Печатаем моих друзей", access_to_my_friends())
    # print("Печатаем друзей моих друзей", all_my_friends2)
    print("У нас есть общие друзья, это - {}".format(c))
